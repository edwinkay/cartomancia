...
export class PrediccionesService {
  imagen1 =
    'https://raw.githubusercontent.com/edwinkay/cartomancia/master/src/assets/images/';
  imagen2 =
    'https://raw.githubusercontent.com/edwinkay/cartomancia/master/src/assets/images/';
  imagen3 =
    'https://raw.githubusercontent.com/edwinkay/cartomancia/master/src/assets/images/';
  ...
  predicciones: any[] = [
    ...
    },
    {
      ...
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Amor, Esta combinación suele referirse a que una persona que se acerca a ti con posibilidades serias en el amor. Es una oportunidad que llega y que puede indicar que la relación se te concede. El triunfo en alguna relación sentimental en parejas que ya tienen bastante tiempo, así como parejas que se están consolidando recientemente.',
    },
    {
      imagen1: this.imagen1 + 'copa10' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Amor realizado, Esta conjunción es indicativo de la llegada de una persona conocida y por la que habías esperado mucho tiempo; nuevamente se acerca para ofrecer sentimientos y una relación. O bien, te dice que la persona que te interesa por fin toma una decisión de concretar la relación como se deseaba.',
    },
    {
      imagen1: this.imagen1 + 'copa10' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Sorpresa, Puede referirse al trabajo con buenas relaciones personales, así como una grata sorpresa relacionada con el área laboral donde se permitirá brillar o bien tener el reconocimiento que se había estado esperando. Habla también de la cosecha de buenos frutos en los negocios que anteriormente se habían proclamado. Es indicativo de la toma de decisiones como iniciativa propia.',
    },
    {
      imagen1: this.imagen1 + 'copa10' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Infidelidad, Esta conjunción puede representar muchos problemas dentro del área sentimental con la pareja, incluso llegando a indicar la infidelidad por parte de la misma o por parte del consultante. Habla de desacuerdos, relaciones ocultas, amor roto, así como secretos que probablemente debiliten la relación.',
    },
    {
      imagen1: this.imagen1 + 'copa10' + this.f,
      imagen2: this.imagen2 + 'espada2' + this.f,
      conjugacion:
        'Dudas, Es probable que se tema la llegada de un nuevo amor en caso de ya tener pareja, ya sea por parte del consultante o por parte de la pareja. Habla también de las dudas que existen en la relación, esto puede ser de manera específica en  las intenciones que se tienen con la pareja, o bien una infidelidad por parte de la pareja. Amores que no están dispuestos a estar bien o que tienen miedo.',
    },
    {
      imagen1: this.imagen1 + 'copa10' + this.f,
      imagen2: this.imagen2 + 'espada9' + this.f,
      conjugacion:
        'Celos, En esta combinación pueden destacarse las dudas dentro de una pareja o en todo caso, dudas en general, así como los celos que pueden estar desgastando una relación. Puede incluso hablar de una decepción. Señala ansiedad provocada por amor o bien por una pareja al consultante. Refleja sentimientos alterados, sentimientos de atadura por dudas y decepciones que no se pueden superar.',
    },
    {
      imagen1: this.imagen1 + 'copa11' + this.f,
      imagen2: this.imagen2 + 'bastos11' + this.f,
      conjugacion:
        'Idas y venidas, Si el consultante está preguntando por una persona en específico y la lectura es sobre el amor, te está advirtiendo que el hombre en cuestión no es alguien que desee un compromiso, solo quiere pasarla bien, una buena amistad y punto.',
    },
    {
      imagen1: this.imagen1 + 'copa11' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Triunfo en el amor, Si el consultante pregunta por su pareja, la tirada está augurando que la pareja logrará consolidarse, aunque debe tomarse en cuenta que una vez que la situación económica sea mala en la pareja la ruptura será predecible, el consultante deberá evaluar esta situación y hablarlo antes de comprometerse para que haya un precedente de la situación.',
    },
    {
      imagen1: this.imagen1 + 'copa11' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Gente amable, El consultante conocerá a una persona que lo cautivará, aventurera y carismática, que le propondrá hacer un negocio, no específicamente porque se vuelvan socios, más bien le regalará una idea. Al principio el consultante no pondrá mucha atención por considerarlo como algo poco trascendental, pero con el paso de los días la idea se irá apoderando del consultante hasta hacerla realidad, trayendo grandes ganancias.',
    },
    {
      imagen1: this.imagen1 + 'copa11' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Mudanza obligada, Una pareja que debe mudarse, no hay opción de decidir, debe cambiarse de domicilio, ya sea porque se debe dinero o bien, hay una situación que obliga a esta pareja a salir de su hogar. Esta situación es una prueba que deben enfrentar como pareja, no se ve que haya una ruptura, pero sí sacará a flote algunos sentimientos que han estado guardados por mucho tiempo y es el momento de enfrentarlos como pareja.',
    },
    {
      imagen1: this.imagen1 + 'copa11' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Noticia desagradable, Malas noticias llegan para el consultante, que cambiarán el rumbo de su vida; aunque no es una sorpresa del todo ya que se venían gestando situaciones incómodas en torno a la pareja, el trabajo o la familia, y se dejó pasar para no tener problemas, así que la vida te enfrenta a tomar decisiones y es el momento de aprovechar este impulso.',
    },
    {
      imagen1: this.imagen1 + 'copa11' + this.f,
      imagen2: this.imagen2 + 'oro3' + this.f,
      conjugacion:
        'Dinero inesperado, Al consultante le llega dinero inesperado, a pesar de que podría traer una gran alegría, llega el momento de tomar una decisión con respecto a progresar en el trabajo. Para ello debes viajar y salir de tu zona de confort. La desidia se apoderó de la voluntad del consultante y el pretexto número uno fue no tener dinero, ahora ya lo tienes y es tiempo de moverse y actuar.',
    },
    {
      imagen1: this.imagen1 + 'copa12' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Hombre favorable, El consultante está pasando por un momento de desequilibrio emocional, así que encontrará en su camino a un hombre que le traerá la paz mental y le enseñará a cultivar la paciencia y la templanza. Será como un guía espiritual que le ayudará a transformar su vida para siempre, de manera positiva.',
    },
    {
      imagen1: this.imagen1 + 'copa12' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Empleo por recomendación, Si el consultante está preguntando por encontrar trabajo, seguramente lo encontrará de la mano de un hombre mayor que le ayudará. El consultante agradecerá la oportunidad sin saber que este hombre a la larga le hará ver su suerte al manipularlo a su favor.',
    },
    {
      imagen1: this.imagen1 + 'copa12' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Casa nueva, Un gran regalo llagará a la vida del consultante a través de la mano de un hombre mayor, que siempre consideró su maestro o a quien le tenía admiración, puede ser familiar o no. Es un regalo inesperado que le cambiará la vida para bien.',
    },
    {
      imagen1: this.imagen1 + 'copa12' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'As de espadas = Traición, Sin esperarlo, el consultante se verá envuelto en un escándalo donde será la persona que traicionó la confianza de la empresa donde trabaja, así que no se dará cuenta que fue víctima de un hombre mayor que le puso una trampa y lo inculpó.',
    },
    {
      imagen1: this.imagen1 + 'copa12' + this.f,
      imagen2: this.imagen2 + 'bastos8' + this.f,
      conjugacion:
        'Inseguridad, Hay una persona que está cerca del consultante y está creando en él mucha inseguridad. Un hombre mayor que está queriendo que el consultante comience a cometer errores para quedarse con todo lo que él ha construido, ya que desde hace tiempo ha planeado quitarle su vida, apoderarse de su esposa, su casa y su empresa, por lo que no parará hasta conseguirlo.',
    },
    {
      imagen1: this.imagen1 + 'copa12' + this.f,
      imagen2: this.imagen2 + 'copa6' + this.f,
      conjugacion:
        'El pasado regresa, Una deuda de juego que en su momento se cobró. Regresa del pasado la o las personas que hicieron que el consultante cayera en este vicio. Lo que esta tirada le está pidiendo al consultante es que tenga cuidado de volver a caer en vicios del pasado o de retomar amistades que solo le traerán dolor.',
    },
    {
      imagen1: this.imagen1 + 'asDeEspadas' + this.f,
      imagen2: this.imagen2 + 'copa9' + this.f,
      conjugacion:
        'Triunfo, Esta combinación es una de las mejores en la baraja española. Indica que aquello que deseas se encuentra al alcance de tu mano, sólo debes actuar para lograrlo.',
    },
    {
      imagen1: this.imagen1 + 'asDeEspadas' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
    ...
    },
    {
      ...
      conjugacion:
        'Amor sano, Cuando aparece la Reina de Oros junto al As de Espadas, significa que la persona de interés del consultante es una persona sincera, con la cual comenzará una relación romántica cargada de sinceridad.',
    },
    {
      imagen1: this.imagen1 + 'asDeEspadas' + this.f,
      imagen2: this.imagen2 + 'espada9' + this.f,
      conjugacion:
        'Mentiras, La combinación de estas dos barajas advierten al consultante sobre traiciones y desengaños. Le recomienda modificar su actitud frente a la vida, ya que es él mismo quien inconscientemente elige aferrarse al dolor. Recibirá palabras y mensajes muy dolorosos, pero está en él salir adelante.',
    },
    {
      imagen1: this.imagen1 + 'asDeEspadas' + this.f,
      imagen2: this.imagen2 + 'oro5' + this.f,
      conjugacion:
        'Estancamiento, Aquí las cartas nos hablan de un bloqueo mental y de la necesidad de revisar el orgullo excesivo y dañino que presenta el consultante. La persona se encuentra en un profundo estado de negatividad. No sabe buscar el amor, necesita encontrar las herramientas adecuadas para ello.',
    },
    {
      imagen1: this.imagen1 + 'asDeEspadas' + this.f,
      imagen2: this.imagen2 + 'espada3' + this.f,
      conjugacion:
        'Dolor, Esta combinación advierte sobre un conflicto imposible de solucionar. No habrá una segunda oportunidad. Sin embargo, una vez que se supera el dolor generado por este fracaso se podrá comenzar una nueva etapa coronada por el éxito. Si está consultando sobre una crisis o ruptura amorosa, nos está hablando de un tercero en discordia y el triunfo de esta nueva relación a costa del dolor del consultante. Por lo tanto es una combinación que habla de una injusticia y un engaño.',
    },
    {
      imagen1: this.imagen1 + 'espada2' + this.f,
      imagen2: this.imagen2 + 'bastos6' + this.f,
      conjugacion:
        'Éxito, Cuando estas dos barajas aparecen juntas, aconsejan al consultante mantener el silencio respecto a sus planes y estrategias. Es clave para salir victorioso de cualquier situación que se presente. El éxito que se obtendrá disipará todas las dudas y miedos.',
    },
    {
      imagen1: this.imagen1 + 'espada2' + this.f,
      imagen2: this.imagen2 + 'copa3' + this.f,
      conjugacion:
        'Celebración en el amor, Esta conjugación habla de la vida sentimental del consultante, de sus recelos y miedos respecto al amor. Posiblemente haya vivido experiencias dolorosas en el pasado; sin embargo, estas barajas juntas anuncian el triunfo sobre cualquier recelo, y la consiguiente apertura a un nuevo amor. Los amigos serán un apoyo clave en esto, aunque para un porcentaje de consultantes también puede ser este nuevo amor quien brinde la contención necesaria.',
    },
    {
      imagen1: this.imagen1 + 'espada2' + this.f,
      imagen2: this.imagen2 + 'oro12' + this.f,
      conjugacion:
        'Triunfo, Estas dos barajas combinadas anuncian al consultante que, por más fuertes que sean sus miedos, logrará salir adelante y dejarlos atrás. Para esto, contará con la amistad de una mujer joven y morena. Con su apoyo el consultante logrará vencer sus temores y abrirse al amor.',
    },
    {
      imagen1: this.imagen1 + 'espada2' + this.f,
      imagen2: this.imagen2 + 'copa5' + this.f,
      conjugacion:
        'Dolor autoinfligido, Aquí pueden presentarse dos situaciones; se podrá definir cuál de ellas es la correcta según el caso, de acuerdo a una carta extra o a la autocrítica del consultante. Por un lado, puede estar viviendo una situación que no es de por sí en extremo negativa, pero en su mente está creando un estado emocional desproporcionadamente doloroso respecto a la realidad. Por otro lado, el consultante simplemente puede estar en un estado de negación, ignorando el hecho de estar dolido.',
    },
    {
      imagen1: this.imagen1 + 'espada2' + this.f,
      imagen2: this.imagen2 + 'espada8' + this.f,
      conjugacion:
        'Miedo y resignación, El consultante se encuentra en un momento en el que tiene mucho miedo, no sólo a enamorarse sino al amor en general. También cree que no tiene solución; no tiene la capacidad para ver la manera de superar estos miedos y cree por lo tanto, que jamás podrá salir de esta',
    },
    {
      imagen1: this.imagen1 + 'espada2' + this.f,
      imagen2: this.imagen2 + 'bastos9' + this.f,
      conjugacion:
        'Bloqueos, Esta combinación de barajas indica, cuando la consulta es referida al ámbito financiero, que no deben proporcionarse préstamos a nadie, aún si se trata de personas conocidas o de confianza. En otros aspectos señala que el consultante puede encontrarse muy a la defensiva y generarse a sí mismo bloqueos mentales y emocionales, por miedos desproporcionados.',
    },
    {
      ...
      conjugacion:
        'Asociaciones positivas, En esta combinación, la carta que podría estar hablando de algo negativo se encuentra orientada en el pasado. El consultante ha finalizado una asociación con una persona muy querida debido a algún conflicto.Con el Dos de Copas, se indica que la persona con la que se realizará la nueva sociedad es de confianza, y tiene buenos sentimientos hacia el consultante. En el futuro, puedes ver una baraja sumamente favorable, el 3 de Oros, que anuncia expansión económica',
    },
    {
      imagen1: this.imagen1 + 'espada3' + this.f,
      imagen2: this.imagen2 + 'copa12' + this.f,
      ...
      conjugacion:
        'Pretendiente, Si la consulta está realizada por una mujer, le anuncia que hay un hombre mayor, castaño, que siente un profundo interés por ella. Podría estar enamorado incluso. En el mediano plazo es probable que le invite a salir.',
    },
    {
      imagen1: this.imagen1 + 'espada3' + this.f,
      imagen2: this.imagen2 + 'bastos8' + this.f,
      conjugacion:
        'amor, La combinación con esta carta es sumamente positiva, especialmente cuando el consultante viene de relaciones conflictivas y dolorosas, ya que anuncia la llegada de un nuevo amor; uno totalmente inesperado, incluso si no lo está buscando. Será un amor tan sano, que el consultante logrará sanar sus heridas.',
    },
    {
      imagen1: this.imagen1 + 'espada3' + this.f,
      imagen2: this.imagen2 + 'espada9' + this.f,
      conjugacion:
        'Sugestión, El consultante necesita ser un poco más objetivo. Cuando se encuentra con el 9 de espadas, indica que se está auto boicoteando generándose preocupaciones a sí mismo donde no hay conflictos.',
    },
    {
      imagen1: this.imagen1 + 'espada3' + this.f,
      imagen2: this.imagen2 + 'oro5' + this.f,
      conjugacion:
        'Pérdidas, Será necesario ajustar un poco los gastos, ya que, la combinación junto a esta carta, habla de un exceso en los mismos sea por imprudencia o por mala planificación. Si no se observa esta conducta, puede desencadenar en problemas mayores.',
    },
    {
      imagen1: this.imagen1 + 'espada3' + this.f,
      imagen2: this.imagen2 + 'copa5' + this.f,
      conjugacion:
        'Conflictos, El consultante podría estar a punto de cometer un error con la persona a quien ama. Se sugiere meditar antes de actuar, y buscar las mejores maneras de fomentar la buena comunicación con su persona de interés, a fin de evitar conflictos.',
    },
    {
      imagen1: this.imagen1 + 'espada4' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Descanso y recuperación, Tras un sufrir una enfermedad que paralizó de toda actividad al consultante, está recuperando su salud, después de un periodo muy prolongado sin descanso, especialmente por cuestiones de trabajo. Pero hoy la vida le ofrece un periodo para que viva plenamente en paz y en una constante reflexión disfrute de su soledad. Así que la vida le da una oportunidad al consultante para tener un cambio de actitud.',
    },
    {
      imagen1: this.imagen1 + 'espada4' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Salida del hospital, Tras un largo periodo en reclusión, el consultante vuelve a integrarse a la vida diaria, el reto es que se debe integrar a la sociedad y le causa un poco de miedo porque no sabe cómo afrontar esta situación, por lo que se encierra en sí mismo. El apoyo que necesita no está afuera en los demás, sino en su mente, donde el consultante debe hacer consciencia de lo que vale, aún con los cambios que trajo la',
    },
    {
      imagen1: this.imagen1 + 'espada4' + this.f,
      imagen2: this.imagen2 + 'oro10' + this.f,
      conjugacion:
        'Oportunidades laborales, Tras un largo periodo de inactividad laboral, llega una mujer del pasado para tenderle la mano al consultante. El reto es aceptar los errores del pasado y no volverlos a cometer; para ello, el consultante debe hacer una reflexión de por qué lo despidieron del empleo, no para culparse, sino para entender cuáles fueron sus errores y tomar la nueva oportunidad sin volverlos a cometer.',
    },
    {
      imagen1: this.imagen1 + 'espada4' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Amor desleal, Una persona cercana a la pareja del consultante ha estado comentando detalles sobre su relación de pareja y estas indiscreciones han causado un distanciamiento con la pareja del consultante, hasta el punto de la separación. El consultante se siente traicionado por su pareja, ya que ha hecho más caso a los chismes, en lugar de hablar directamente y enfrentar la situación, sin saber que su pareja no desea desde hace tiempo seguir con el consultante, siendo el golpe fatal que recibirá.',
    },
    {
      imagen1: this.imagen1 + 'espada4' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Amor sin escrúpulo, El consultante ha pasado tiempo sin pareja, siente un vacío emocional; quiere comenzar una relación, por lo que la tirada le pide al consultante ser cauto con la persona que elige ya que se acercará por interés y con el deseo de quedarse con todo lo que tiene. Cuidado con un amor tóxico, que te deje sin nada material y emocional.',
    },
    {
      imagen1: this.imagen1 + 'espada4' + this.f,
      imagen2: this.imagen2 + 'espada8' + this.f,
      conjugacion:
        'Muerto en vida, Esta combinación señala que el consultante carece de voluntad. Se ha vuelto una carga pesada para su familia, ya que su apatía por la vida lo mantiene aislado del mundo. Se niega a darse cuenta que es capaz de salir del encierro, está sano y es capaz de trabajar.',
    },
    {
      imagen1: this.imagen1 + 'espada5' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Resolución positiva, Esta combinación da esperanzas al consultante si se encuentra atravesando una situación complicada, tanto en un negocio como en cualquier otro ámbito. Indica que se saldrá triunfante, pero es necesario actuar cuanto antes para disipar los celos y las dudas de las otras personas involucradas.',
    },
    {
      imagen1: this.imagen1 + 'espada5' + this.f,
      imagen2: this.imagen2 + 'oro9' + this.f,
      conjugacion:
        'Evolución personal, Cuando estas barajas salen juntas, indican que el consultante es capaz de hacer una auto crítica constructiva. Aprende a dejar de lado las actitudes y pensamientos deshonestos, se vuelve alguien independiente, aunque aún debe revisar algunas actitudes egoístas.',
    },
    {
      imagen1: this.imagen1 + 'espada5' + this.f,
      imagen2: this.imagen2 + 'oro8' + this.f,
      conjugacion:
        'Amor constructivo, Si el consultante se encuentra atravesando una situación conflictiva en su pareja, esta combinación indica que el amor es tan grande que lograrán suavizar y superar las diferencias y la crisis presente. En otro orden de cosas, anuncia que logrará el empleo deseado gracias a la influencia de alguien.',
    },
    {
      imagen1: this.imagen1 + 'espada5' + this.f,
      imagen2: this.imagen2 + 'oro5' + this.f,
      conjugacion:
        'Dolor, En este caso, el consultante exhibe un nivel de egoísmo tan elevado que simplemente lo llevará a la ruina. Sufrirá una ruptura dolorosa. Si planea un viaje será extremadamente difícil. Se alejarán las personas de su entorno.',
    },
    {
      imagen1: this.imagen1 + 'espada5' + this.f,
      imagen2: this.imagen2 + 'copa3' + this.f,
      conjugacion:
        'Falsedad, Es un gran llamado de atención a los valores del consultante. Podría estar siendo infiel a su pareja; u ocultando fiestas y actividades que realiza la persona misma o aquellas cercanas. Sostiene una conducta nociva para consigo y los demás, pero en vez de reflexionar al respecto simplemente lo celebra.',
    },
    {
      imagen1: this.imagen1 + 'espada5' + this.f,
      imagen2: this.imagen2 + 'copa2' + this.f,
      conjugacion:
        'Espejismos, Esta combinación anuncia la reconciliación entre el consultante y otra persona. Sin embargo, debe tener cuidado ya que hay muchas cosas que no se aclaran y puede tratarse de un engaño.',
    },
    {
      imagen1: this.imagen1 + 'espada6' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Nuevos caminos, Si el consultante se siente en una encrucijada y aparecen estas barajas combinadas, no debe dudarlo, retirarse será la mejor opción. De esta manera y abriéndose a los cambios, dará lugar a nuevas oportunidades que serán mucho mejores y positivas.',
    },
    {
      imagen1: this.imagen1 + 'espada6' + this.f,
      imagen2: this.imagen2 + 'oro6' + this.f,
      conjugacion:
        'Renovación, Cuando se conjugan estas barajas anuncian un mejor trabajo para el consultante. Si está lidiando con fantasmas del pasado, podrá superarlos y dejarlos atrás dedicándose de lleno a su nuevo trabajo.',
    },
    {
      imagen1: this.imagen1 + 'espada6' + this.f,
      imagen2: this.imagen2 + 'bastos3' + this.f,
      conjugacion:
        'Triunfo, Estas dos barajas juntas alientan al consultante a continuar la lucha, valdrán la pena el esfuerzo y los posibles sinsabores. El resultado que vaticina es un futuro muy prometedor.',
    },
    {
      imagen1: this.imagen1 + 'espada6' + this.f,
      imagen2: this.imagen2 + 'bastos5' + this.f,
      conjugacion:
        'Conflictos, Esta combinación es bastante negativa. El consultante se encuentra transitando un mal momento, y será aún peor con el transcurso del tiempo. Anuncia disputas inevitables. Será necesario procurar mantener la calma y la claridad mental para salir de la mejor manera posible de estas situaciones.',
    },
    {
      imagen1: this.imagen1 + 'espada6' + this.f,
      imagen2: this.imagen2 + 'espada8' + this.f,
      conjugacion:
        'Cargas negativas, La recomendación de esta conjugación es no lanzarse a los cambios, ya que serán sumamente negativos, perjudicarán bastante al consultante. Debe también revisar las cargas mentales que arrastra del pasado, ya que son las que no le impiden avanzar, y pagará un poco caras las consecuencias.',
    },
    {
      imagen1: this.imagen1 + 'espada6' + this.f,
      imagen2: this.imagen2 + 'espada3' + this.f,
      conjugacion:
        'Traición, Cuando aparecen estas dos barajas juntas, anuncian una ruptura dolorosa y el descubrimiento de una traición. El consultante querrá alejarse del dolor que siente, pero deberá transitarlo para sanarlo y no sufrir las consecuencias a futuro.',
    },
    {
      imagen1: this.imagen1 + 'espada7' + this.f,
      imagen2: this.imagen2 + 'bastos4' + this.f,
      conjugacion:
        'Trauma sexual, El consultante puede estar envuelto a un suceso muy traumático en su vida que tiene que ver con su vida sexual; puede estar avisando sobre una posible violación o acto sexual que le deje una gran impresión, siendo el parte aguas para que sufra un cambio drástico que provoque un trauma sexual.',
    },
    {
      imagen1: this.imagen1 + 'espada7' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Ruptura de relación, El consultante ha puesto los ojos en una pareja que está muy por encima de su estilo de vida y educación. Cuando comenzó la relación parecía un sueño del que no quería despertar la pareja, solo que el tiempo y la cotidianidad le ha mostrado la verdadera personalidad de cada uno, lo que ha traído una gran desilusión de ambas partes, por lo que la ruptura es evidente.',
    },
    {
      imagen1: this.imagen1 + 'espada7' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Enfermedad grave, El consultante ha llevado una vida de malos hábitos alimenticios o con vicios, que han puesto en riesgo su salud, a tal grado que ha caído en cama. La tirada augura que pasará un periodo largo para que se recupere al 100 por ciento.  Este tiempo se recomienda reflexionar y tratar de mejorar lo negativo en su vida.',
    },
    {
      imagen1: this.imagen1 + 'espada7' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Cambio de mentalidad, Cuando aparece esta combinación en la vida del consultante, marca el fin de una etapa que se caracterizó por la mediocridad, así que es momento de que transforme sus pensamientos para el futuro, de manera más optimista y dando paso a una etapa de brillo y abundancia. El futuro no puede ser más esperanzador con el As de oros como final de la tirada, todo lo que deseaste se cumplirá. La única condición que debe cumplir el consultante es ser positivo y tomar la rienda de su vida.',
    },
    {
      imagen1: this.imagen1 + 'espada7' + this.f,
      imagen2: this.imagen2 + 'oro3' + this.f,
      conjugacion:
        'Esperanza, Todos tacharon al consultante de soñador, pero jamás dejó de lado la idea que juraba le daría grandes satisfacciones. Trabajó día tras día y por fin el negocio, producto o servicio que ideó empezará a darle frutos, hasta llegar un periodo de mejora económica. Lo que esta tirada le está advirtiendo al consultante es que tenga cuidado de la gente de la cuales rodea, ya que puede haber oportunistas que tiren todo su esfuerzo.',
    },
    {
      imagen1: this.imagen1 + 'espada7' + this.f,
      imagen2: this.imagen2 + 'oro11' + this.f,
      conjugacion:
        'Viaje, A la vida del consultante llegará un hombre joven que le traerá una chispa de vida, un entusiasmo que hace tiempo no sentía. Pero ahora se siente motivado, esperanzado y con ganas de “comerse” el mundo. La tirada le advierte al consultante que tenga cuidado con el joven encantador porque puede ser maravilloso todo lo que cuenta, pero no todo es real, es mejor andar con pies de plomo y no dejarse embaucar, aunque sí puede servir de motivación.',
    },
    {
      imagen1: this.imagen1 + 'espada8' + this.f,
      imagen2: this.imagen2 + 'bastos6' + this.f,
      conjugacion:
        'Encuentro placentero, Este será un periodo sexualmente activo para el consultante, si no cuenta con pareja encontrará una pareja casual o un “amigo” que se convierta en su pareja sexual, sin compromisos. Para que sea una situación armoniosa entre ambas personas, deberán hablar de que solo es un encuentro fortuito y no hay una relación, ni se piensa en tratar de crear un vínculo afectivo; de lo contrario, existirá el riesgo de que la situación se torne muy tortuosa para alguno de los dos, que pensó que podría ser amor.',
    },
    {
      imagen1: this.imagen1 + 'espada8' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Liberación, Lo que te pide esta tirada es que seas consciente de tus errores; primero que los aceptes y comiences a perdonarte por esta situación; segundo que tomes la rienda de tu vida en tus manos. No creas que no vas a volver a equivocarte, lo que sí debes de tener por seguro es la enseñanza de vida que vas a tener y a partir de ella, será un parte aguas para que enfrentes la situaciones y dejes de evadir tus responsabilidades.',
    },
    {
      imagen1: this.imagen1 + 'espada8' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Perdón, Esta tirada le pide al consultante que deje de prestar atención a las críticas del exterior, que es momento de adueñarse de las situaciones y tomar decisiones sin prestar atención a lo que dice la gente a su alrededor. Una vez que haya reflexionado hasta donde es su responsabilidad, se podrá liberar de culpas ajenas.',
    },
    {
      imagen1: this.imagen1 + 'espada8' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Escapar de la justicia, La astucia se usa para fines negativos y el consultante es inteligente, solo que se metió en problemas recientemente, de actividades relacionadas con drogas y sexo, así que para salvar su integridad física tuvo que huir. La reflexión es que el consultante entienda que huir no es la solución, y si debe asumir una consecuencia legal, es mejor hacerlo que vivir huyendo.',
    },
    {
      imagen1: this.imagen1 + 'espada8' + this.f,
      imagen2: this.imagen2 + 'espada3' + this.f,
      conjugacion:
        'Inmadurez, Esta tirada está indicando al consultante que deje de actuar como un adolescente irresponsable y que es el momento de madurar; la carta está augurando que en breve el consultante se meterá en serios problemas, cayendo en la cárcel o en el hospital por su negligencia e inmadurez.',
    },
    {
      imagen1: this.imagen1 + 'espada8' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Juicio perdido, Esta tirada le advierte al consultante que en breve se verá involucrado en un juicio legal, lo que le aconseja esta combinación es que no interponga la demanda, ya que la parte contraria es una persona con poco escrúpulos que hará todo lo que esté en sus manos para hacer que el consultante pierda el juicio; y cuando esto suceda, no parará hasta ver muy mal al consultante.',
    },
    {
      imagen1: this.imagen1 + 'espada9' + this.f,
      imagen2: this.imagen2 + 'copa3' + this.f,
      conjugacion:
        'Reconciliación, La persona de interés del consultante habría sido sincera y sufrió. Logran superar una serie de celos y desengaños, alcanzando la reconciliación. El consultante frecuentará personas y fiestas o eventos que le ayudarán a olvidar un poco sus preocupaciones.',
    },
    {
      imagen1: this.imagen1 + 'espada9' + this.f,
      imagen2: this.imagen2 + 'oro4' + this.f,
      conjugacion:
        'Superación, La combinación de estas barajas sugiere guardarse los problemas para sí mismo. Se disiparán los miedos y dudas, de manera tal que se superará un mal momento. Mantener la calma es fundamental.',
    },
    {
      imagen1: this.imagen1 + 'espada9' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Resoluciones y comienzos, Esta conjugación sugiere y anuncia el abandono de los sentimientos de culpa. Al liberarnos de esta sensación, el consultante encontrará la oportunidad de solucionar aquello que le preocupa. Indica también la llegada de un nuevo amor.',
    },
    {
      imagen1: this.imagen1 + 'espada9' + this.f,
      imagen2: this.imagen2 + 'espada5' + this.f,
    ...
    },
    {
      ...
      imagen2: this.imagen2 + 'bastos9' + this.f,
      conjugacion:
        'Inestabilidad, Esta combinación nos habla de miedos que posiblemente no tengan correlación con la realidad, con tristeza y una sensación de indefensión. El consultante se encuentra con una gran confusión e inseguridad respecto a sus sentimientos.',
    },
    {
      imagen1: this.imagen1 + 'espada9' + this.f,
      imagen2: this.imagen2 + 'espada8' + this.f,
      conjugacion:
        'Bloqueos auto impuestos, Al presentarse esta conjugación, se confirma mucho de lo que hemos hablado a lo largo de este artículo: el consultante sufre bloqueos y se encuentra inmovilizado, a causa de sus propias preocupaciones y una profunda sensación de culpa.',
    },
    {
      imagen1: this.imagen1 + 'espada10' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Triunfo amoroso, Probablemente la relación del consultante se vea en crisis a causa de recelos, posiblemente infundados. El consejo que se brinda en esta combinación es tener valor para dialogar con la pareja, y de esta forma alcanzará la felicidad.',
    },
    {
      imagen1: this.imagen1 + 'espada10' + this.f,
      imagen2: this.imagen2 + 'copa10' + this.f,
      conjugacion:
        'Amor audaz, Esta conjugación vaticina la llegada de una propuesta amorosa arriesgada; vendrá de la mano de una persona joven. Este amor romperá todas las fronteras y obstáculos posibles.',
    },
    {
      imagen1: this.imagen1 + 'espada10' + this.f,
      imagen2: this.imagen2 + 'asDeOro' + this.f,
      conjugacion:
        'Buena oportunidad, Cuando aparece esta combinación, llegará una muy buena oportunidad de la cual desconfiará el consultante. El consejo es no mostrarse demasiado abierto y no apresurarse. De esta manera se le dará la oportunidad. Confía, el dinero llegará.',
    },
    {
      imagen1: this.imagen1 + 'espada10' + this.f,
      imagen2: this.imagen2 + 'espada5' + this.f,
      conjugacion:
        'Egoísmos, Estas barajas, cuando aparecen juntas, hablan de una persona no sólo desconfiada y egoísta, sino carente de ética también. Anuncia también que se está planificando una venganza. Si esta combinación se refiere al consultante, es un llamado de atención a actuar de manera correcta.',
    },
    {
      imagen1: this.imagen1 + 'espada10' + this.f,
      imagen2: this.imagen2 + 'espada7' + this.f,
      conjugacion:
        'Secretos, En esta conjugación vemos a una persona que posee un secreto muy peligroso, falsa y que se vende al mejor postor. Se recomienda al consultante ser precavido.',
    },
    {
      imagen1: this.imagen1 + 'espada10' + this.f,
      imagen2: this.imagen2 + 'bastos7' + this.f,
      conjugacion:
        'Posibles engaños, Estas cartas son un llamado urgente a estar atentos y atender la intuición y los conocimientos previos que se tienen, ya que hay personas que quieren engañarnos.',
    },
    {
      ...
      imagen3: this.imagen3 + 'oro3' + this.f,
      conjugacion:
        'Triunfo, Cuando el Caballo de Espadas y el As de Oros aparecen juntos,  hablan de que se obtiene algo que se estaba buscando. El 3 de Oros delimita este triunfo, indicando que se trata específicamente de un asunto legal, un juicio ganado.',
    },
    {
      imagen1: this.imagen1 + 'espada11' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Regreso, Esta combinación anuncia el regreso de un ser querido. Puede o no ser una sorpresa para quien lo recibe de vuelta.',
    },
    {
      imagen1: this.imagen1 + 'espada11' + this.f,
      imagen2: this.imagen2 + 'oro8' + this.f,
      conjugacion:
        'Dinero recuperado, Estas dos cartas señalan que una lucha por recuperar un dinero llega a su fin, y el dinero en cuestión por fin será devuelto o recuperado.',
    },
    {
      imagen1: this.imagen1 + 'espada11' + this.f,
      imagen2: this.imagen2 + 'bastos2' + this.f,
    ...
    },
    {
      ...
      conjugacion:
        'Accidente en auto, La combinación advierte también de un accidente, solo que este se puede dar en el trayecto hacia el trabajo o en un viaje por motivos laborales. Por lo que hay que tener cuidado durante los desplazamientos que tengan que ver con temas de trabajo, incluso regresando a casa desde el mismo.',
    },
    {
      imagen1: this.imagen1 + 'espada12' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Amor leal, Esta combinación habla de un hombre distanciado de los sentimientos, que en cierta forma no cree en el amor y de pronto, se enamora, volviéndose no solo un hombre enamorado sino leal.',
    },
    {
      imagen1: this.imagen1 + 'espada12' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Nuevo comienzo, Estas dos cartas señalan que se siente una pasión enérgica por la vida, que servirá como impulso para tener un nuevo comienzo.',
    },
    {
      imagen1: this.imagen1 + 'espada12' + this.f,
      imagen2: this.imagen2 + 'oro9' + this.f,
      conjugacion:
        'Logro alcanzado, Después de luchar con perseverancia y con la seguridad de que se va a lograr el objetivo, esta combinación indica que se logra lo que se buscaba. Muy probablemente exista un matrimonio con muy buena posición económica.',
    },
    {
      imagen1: this.imagen1 + 'espada12' + this.f,
      imagen2: this.imagen2 + 'bastos9' + this.f,
    ...
    },
    {
      ...
      imagen3: this.imagen3 + 'espada9' + this.f,
      conjugacion:
        'Accidente, La conjunción de estas cartas previene de un posible accidente. Por ello esta triada es una advertencia para estar alerta y hacer las cosas con cuidado, reduciendo los riesgos al mínimo posible.',
    },
    {
      imagen1: this.imagen1 + 'asDeBastos' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Buenas noticias, La primera carta de bastos, nos señala que de forma repentina que va a suceder algo, mientras que el As de Oros indica que se avecinan noticias favorables de forma inesperada para el consultante, por lo tanto es la llegada de buenas nuevas o que pueden traer alguna alegría, beneficio o éxito, sobretodo si se esta emprendiendo un proyecto o esperando una respuesta positiva a una situación específica.',
    },
    {
      imagen1: this.imagen1 + 'asDeBastos' + this.f,
      imagen2: this.imagen2 + 'bastos2' + this.f,
      conjugacion:
        'Viaje inesperado, Esta combinación es una advertencia para el consultante, debido a que sin esperarlo tendrá que trasladarse fuera de la ciudad porque le llega alguna noticia del exterior, resolver algún problema o, simplemente por placer. Pero cualquiera que sea la razón, no estaba dentro de los planes del consultante realizar este viaje.',
    },
    {
      imagen1: this.imagen1 + 'asDeBastos' + this.f,
      imagen2: this.imagen2 + 'bastos3' + this.f,
      conjugacion:
        'Muestras amorosas, Si estas cartas salen juntas, nos indican que llegará algún regalo de un ser querido. También puede que llegue a nuestra vida alguien a quien apreciaremos mucho o simplemente, señala la salida o reunión con un amigo muy apreciado o con la pareja sentimental del consultante.',
    },
    {
      imagen1: this.imagen1 + 'asDeBastos' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Robo, La combinación de estas cartas señala que se perderá algo, es decir, que habrá un hurto de algún objeto, dinero, tiempo, o que “te roban” tu estabilidad emocional. Una forma de definirlo con mayor precisión es observar las cartas que se encuentran alrededor para poder saber exactamente de qué clase de pérdida se está hablando. Cuando estas cartas salen juntas, señalan que es momento de soltar y dejar ir aquello que no puede permanecer en tu vida.',
    },
    {
      imagen1: this.imagen1 + 'asDeBastos' + this.f,
      imagen2: this.imagen2 + 'espada7' + this.f,
      conjugacion:
        'Enfermedad, Esta combinación señala que de forma sorpresiva podría haber alguna enfermedad derivada del estrés o podría ser debido a un contagio infeccioso. Sí hay recuperación, pero el consultante debe cuidarse para que este padecimiento no se convierta en algo crónico o que dure mucho tiempo.',
    },
    {
      imagen1: this.imagen1 + 'asDeBastos' + this.f,
      imagen2: this.imagen2 + 'copa5' + this.f,
      conjugacion:
        'Tristezas, El consultante o la persona por la que se pregunta dentro de la lectura, se entera de algo que le está generando mucha tristeza, pues las emociones se encuentran a flor de piel. Es importante saber que puede sentirse mal, pero que no se quede en ese estado para poder solucionar aquello que le aqueja.',
    },
    {
      imagen1: this.imagen1 + 'bastos2' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Entrada de dinero, Un viaje corto te hará conocer personas, conduciéndote hacia un nuevo camino que te dejará mucho dinero. Si eres emprendedor haz realidad tu sueño, tienes el empuje y el dinero, que te traerán buenas ganancias.',
    },
    {
      imagen1: this.imagen1 + 'bastos2' + this.f,
      imagen2: this.imagen2 + 'bastos7' + this.f,
      ...
      conjugacion:
        'Reconocimientos, Esta combinación te está advirtiendo que aproveches un periodo para consolidar tu imagen pública. Si estás desempleado pide trabajo, seguramente causarás una muy buena impresión ya que tienes un gran magnetismo. No dudes en buscar nuevas oportunidades a través de las relaciones públicas o por medio de las redes sociales.',
    },
    {
      imagen1: this.imagen1 + 'bastos2' + this.f,
      imagen2: this.imagen2 + 'oro2' + this.f,
      conjugacion:
        'Creatividad, Tal vez una nueva propuesta laboral esté llegando en breve a tu vida, no temas aceptarla, tiene buen auguro económico. Lo único que debes tener cuidado es que tus emociones no te traicionen. No será un trabajo fácil pero tú puedes desarrollarlo, solo debes concentrarte y mostrar quién eres.',
    },
    {
      imagen1: this.imagen1 + 'bastos2' + this.f,
      imagen2: this.imagen2 + 'bastos7' + this.f,
    ...
    },
    {
      ...
      imagen3: this.imagen3 + 'espada4' + this.f,
      conjugacion:
        'Peligro en el trabajo, Esta combinación te está advirtiendo que tengas cuidado en el trabajo, puedes sufrir un accidente laborar o contagiarte durante una jornada laboral. También puede hablar de un fuerte enfrentamiento con alguien, lo cual podría perjudicarte, dando un giro inesperado en tu vida.',
    },
    {
      imagen1: this.imagen1 + 'bastos3' + this.f,
      imagen2: this.imagen2 + 'copa4' + this.f,
      conjugacion:
        'Cambio positivo, En esta combinación se puede augurar que aquello que se tiene en el momento no es lo que se espera, ya sea en la vida en general o bien en una relación, por lo que indica un cambio radical, que traerá cambios rápidos pero muy positivos a cualquier aspecto que se desee modificar.',
    },
    {
      imagen1: this.imagen1 + 'bastos3' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Productividad, Vienen negocios nuevos bastante productivos y abundantes, indicando una oportunidad extraordinaria en el ámbito laboral. Puede representar también la aparición de una persona que en lo sentimental se relacionará de manera totalmente inesperada.',
    },
    {
      imagen1: this.imagen1 + 'bastos3' + this.f,
      imagen2: this.imagen2 + 'oro11' + this.f,
      conjugacion:
        'Amor estable, Augura la llegada de una persona con intenciones de un amor estable y duradero, aquello que se imagina para un futuro esta apunto de manifestarse.',
    },
    {
      imagen1: this.imagen1 + 'bastos3' + this.f,
      imagen2: this.imagen2 + 'espada3' + this.f,
      conjugacion:
        'Ruptura, Indica aquellos planes que se tenían para el futuro que no salen bien, augurando alguna ruptura en una relación sentimental. Obstáculos y envidias a nivel laboral, proyectos que se truncan.',
    },
    {
      imagen1: this.imagen1 + 'bastos3' + this.f,
      imagen2: this.imagen2 + 'espada8' + this.f,
      conjugacion:
        'Futuro incierto, Refleja un futuro inmediato donde probablemente no se encuentre el camino ideal, sintiéndote así atado de pies y manos, ya que no será posible tomar acción por sí mismo, o bien, teniendo mucha indecisión.',
    },
    {
      imagen1: this.imagen1 + 'bastos3' + this.f,
      imagen2: this.imagen2 + 'bastos9' + this.f,
      conjugacion:
        'Ansiedad, Puede significar poca tranquilidad o bien inestabilidad en el futuro próximo, desconfianza en sí mismo o hacia los demás; lapsos tristes o de ansiedad de no saber qué va pasar.',
    },
    {
      imagen1: this.imagen1 + 'bastos4' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Viaje, Hace tiempo que estás soñando con un viaje y justo se ha alineado el universo, ahora tienes el tiempo y el dinero para realizarlo. En este viaje podrás experimentar nuevas oportunidades, puede surgir un cambio de casa por negocio.',
    },
    {
      imagen1: this.imagen1 + 'bastos4' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Amor pasional, Llega a tu vida un amor si previo aviso que te abraza el corazón, te llena de placeres, por lo que será un periodo de mucha felicidad. ¡Disfrútalo! Recomendación, vive el presente y no pienses cuándo terminará este amor, porque tú mismo estarás atrayendo el final. Además, las personas que están enamoradas comienzan un periodo de expansión económica, así que aprovéchalo.',
    },
    {
      imagen1: this.imagen1 + 'bastos4' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Seguridad laboral, En el trabajo estás pasando un buen momento, tu trabajo habla por ti, los jefes reconocen tu profesionalismo y todo está en paz. A pesar de que haya despidos o movimientos en tu empresa, esta combinación te indica que tu trabajo está asegurando. Pero evita confiarte, la combinación solo te da un respiro para que no te caigan de sorpresa los despidos que vienen.',
    },
    {
      imagen1: this.imagen1 + 'bastos4' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      ...
      conjugacion:
        'Malas relaciones sexuales, Es posible que haya surgido un romance en la oficina, lo que comenzó como algo pasajero, se está volviendo una complicación para ti. Esta relación trae tristeza, desesperación y no existe compatibilidad sexual, por lo que te recomienda actuar de inmediato, sin miedo.',
    },
    {
      imagen1: this.imagen1 + 'bastos4' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
    ...
    },
    {
      ...
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Acuerdos beneficiosos, Cuando estas dos cartas se juntan, te indican que estás por negociar un acuerdo productivo, o cerca de poder cerrar un trato que te traerá muchos beneficios.',
    },
    {
      imagen1: this.imagen1 + 'bastos5' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Opulencia, Cuando esta combinación aparece en una lectura, te puede hablar de una persona con mucho dinero, o una situación en donde te encuentras rodeado de mucha opulencia. No necesariamente se refiere a que tú la obtendrás, sino que puede ser alguien cercano a ti.',
    },
    {
      imagen1: this.imagen1 + 'bastos5' + this.f,
      imagen2: this.imagen2 + 'bastos6' + this.f,
      conjugacion:
        'Inicio de trabajo, Esta combinación le indica al consultante que está en un camino lento pero firme. Especialmente se refiere a una situación laboral, muy probablemente dentro de un trabajo en el cual el consultante recién se inicia y que traerá buenas recompensas con el tiempo.',
    },
    {
      imagen1: this.imagen1 + 'bastos5' + this.f,
      imagen2: this.imagen2 + 'espada6' + this.f,
      conjugacion:
        'Despido, Cuando estas cartas aparecen juntas, anuncian un despido de trabajo inminente, especialmente para el consultante.',
    },
    {
      imagen1: this.imagen1 + 'bastos5' + this.f,
      imagen2: this.imagen2 + 'espada10' + this.f,
      ...
      conjugacion:
        'Crisis laboral, Estas tres cartas juntas hablan de una fuerte crisis que está atravesando el consultante, por falta de trabajo.',
    },
    {
      imagen1: this.imagen1 + 'bastos5' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Daño a terceros, Esta combinación te indica que están intercediendo por una persona con la intención de dañar a un tercero.',
    },
    {
      imagen1: this.imagen1 + 'bastos6' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Reconocimiento de sentimientos, Estas dos cartas juntas son un indicador de que los sentimientos del consultante son reconocidos por las personas o una persona en especial.',
    },
    {
      imagen1: this.imagen1 + 'bastos6' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Fertilidad, La combinación de estas dos cartas anuncia que el consultante goza de buena salud y fertilidad, por si está buscando embarazarse. También indica la abundancia en la que vive el consultante o la buena racha que se aproxima a su vida.',
    },
    {
      imagen1: this.imagen1 + 'bastos6' + this.f,
      imagen2: this.imagen2 + 'oro7' + this.f,
      conjugacion:
        'Viajes, Cuando estas dos cartas salen juntas son buenas noticias que anuncian que harás un viaje a corto plazo, que los planes de viajar se van a materializar próximamente. También puede indicar que te llegará un dinero extra, todo esto gracias a tu buen trabajo.',
    },
    {
      imagen1: this.imagen1 + 'bastos6' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Discusión, Si estas dos cartas aparecen en una lectura, es muy seguro que el consultante se haya involucrado en una discusión fuerte o que próximamente tendrá que enfrentar esta situación.',
    },
    {
      imagen1: this.imagen1 + 'bastos6' + this.f,
      imagen2: this.imagen2 + 'espada11' + this.f,
      imagen3: this.imagen3 + 'espada3' + this.f,
      conjugacion:
        'Accidente en auto, Hay que tener precaución cuando esta combinación de cartas aparece en una lectura, ya que anuncia que el consultante pudiera sufrir un accidente de auto debido a un viaje de trabajo o en el trayecto rumbo a su trabajo.',
    },
    {
      imagen1: this.imagen1 + 'bastos6' + this.f,
      imagen2: this.imagen2 + 'espada6' + this.f,
      conjugacion:
        'Decepciones, La combinación de estas cartas muestra que hay una situación que causa decepción al consultante, puede ser en temas de trabajo, pero también en cuanto a sus relaciones personales.',
    },
    {
      imagen1: this.imagen1 + 'bastos7' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Ascenso laboral, Esta combinación te dice que gracias al trabajo desempeñado, el consultante consigue un éxito fruto del trabajo diario. Le recomienda al consultante no dudar de su capacidad de desempeñar dicho trabajo, y no temer un cambio de puesto o aumento, aunque ésto signifique mayores responsabilidades.',
    },
    {
      imagen1: this.imagen1 + 'bastos7' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Trabajo social, Eres una persona interesada en los movimientos sociales y es un placer para ti hacer algo por los demás, así que tu trabajo te ha llevado a trabajar en una fundación o por una causa, lo cual te traerá satisfacción y dinero para ayudar a los demás. Un sueño que hoy debes hacer realidad y no dudar.',
    },
    {
      imagen1: this.imagen1 + 'bastos7' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Cambio de trabajo, Hay que tomar nuevos retos y buscar nuevas oportunidades laborales, tal vez no tienes la certeza de dónde buscar o pedir trabajo, es momento que comentes con tus colegas o familiares tus planes para encontrar un nuevo trabajo y en un futuro cercano tendrás la respuesta, confía y no dudes en irte a otro trabajo.',
    },
    {
      imagen1: this.imagen1 + 'bastos7' + this.f,
      imagen2: this.imagen2 + 'espada4' + this.f,
      conjugacion:
        'Problemas, Debes cuidar qué comentas en el trabajo, ya sea sobre proyectos o cómo se realiza el trabajo, ya que hay gente mal intencionada que está escuchando atentamente para hacer chismes con los jefes y que quedes como una persona conflictiva y mentirosa, ten cuidado.',
    },
    {
      imagen1: this.imagen1 + 'bastos7' + this.f,
      imagen2: this.imagen2 + 'espada7' + this.f,
    ...
    },
    {
      ...
      conjugacion:
        'Triángulo amoroso, Esta combinación habla de tener cuidado con las personas con las que te relacionas. Alguien puede estar deseando a tu pareja, queriendo incluso causar conflictos que te lleven a la ruptura para poder acercarse al otro.',
    },
    {
      imagen1: this.imagen1 + 'bastos8' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Ayuda en las cargas, La lectura de esta combinación es muy buena, ya que se tiene la ayuda del exterior para salir adelante, la ayuda llega aún sin pedirla, así que tu reacción será positiva ante el conflicto.',
    },
    {
      imagen1: this.imagen1 + 'bastos8' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
    ...
    },
    {
      ...
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Responsabilidades, Es momento de tomar nuevas responsabilidades en nuestra vida, tal vez de inicio nos cause ansiedad o miedo. Lo que te pide esta combinación es que te centres en esta nueva realidad y reacomodes tu vida, una vez que aceptes qué es lo que sucede y fluyas, se hará más fácil salir adelante, de lo contrario solo sufrirás.',
    },
    {
      imagen1: this.imagen1 + 'bastos8' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      conjugacion:
        'Asuntos que se evitan con astucia, Esta tirada está advirtiendo al consultante que puedes ser víctima de una trampa, ya que se puede generar una discusión donde pierdas los estribos y digas cosas que puedan usarse en tu contra. Por miedo a no quedar mal ante los jefes, puedes ser víctima de chantajes.',
    },
    {
      imagen1: this.imagen1 + 'bastos8' + this.f,
      imagen2: this.imagen2 + 'espada6' + this.f,
      conjugacion:
        'Disgustos fuertes, En el trabajo se avecina una etapa de fuertes disgustos con compañeros de trabajo, ya sea por diferencias en el trabajo, o bien, porque tu pasividad ha provocado que tu trabajo caiga en la mediocridad y los compañeros de alrededor no están de acuerdo con tu actuar, así no descuides tu trabajo, sino tendrán motivos para despedirte.',
    },
    {
      imagen1: this.imagen1 + 'bastos8' + this.f,
      imagen2: this.imagen2 + 'asDeEspadas' + this.f,
      ...
      conjugacion:
        'Bajo perfil, Para el consultante es un buen periodo donde todo lo que haga será exitoso y los jefes lo apoyarán. Sin embargo, con esto se presenta una tendencia de alardear dentro del lugar de trabajo, lo cual generará envidias y esto puede generar chismes con mala intención, ideados para perjudicar al consultante y que pierda el apoyo de los superiores.',
    },
    {
      imagen1: this.imagen1 + 'bastos9' + this.f,
      imagen2: this.imagen2 + 'asDeOro' + this.f,
      conjugacion:
        'Suerte, Puede referirse a la suerte que te puedas encontrar en un país extranjero, gracias a alguna buena conexión con algún trabajo o negocio que estará prosperando a favor tuyo, trayendo equilibrio y expansión para tu vida en general. Indica también estabilidad para poder habitar en el extranjero.',
    },
    {
      imagen1: this.imagen1 + 'bastos9' + this.f,
      imagen2: this.imagen2 + 'asDeCopas' + this.f,
      conjugacion:
        'Familia, Es una combinación llena de sorpresas ya que augura la adopción de un hijo. Situaciones en el ámbito sentimental y de la familia que se ven favorecedoras al darte oportunidades para hacer conexión con una persona y comenzar una familia. Incluso indica beneficios para tus padres gracias a ti.',
    },
    {
      imagen1: this.imagen1 + 'bastos9' + this.f,
      imagen2: this.imagen2 + 'bastos12' + this.f,
      conjugacion:
        'Socios, Habla de un buen momento para asociarse con personas y generar un nuevo negocio. También señala un momento próspero en el dinero, que atrae grandes ofertas con un futuro muy prometedor. Indica también la creación de una sociedad con muchos miembros que serán de entera confianza y muy sólidos.',
    },
    {
      imagen1: this.imagen1 + 'bastos9' + this.f,
      imagen2: this.imagen2 + 'espada9' + this.f,
      conjugacion:
        'Presiones, Refiere una advertencia para el consultante con referencia a las personas que le rodean en el trabajo o lo laboral, indicando presión psicológica por parte de los colaboradores. Representando peligro al no permitir el libre desenvolvimiento de actividades simples, afectando la forma de trabajar.',
    },
    {
      imagen1: this.imagen1 + 'bastos9' + this.f,
      imagen2: this.imagen2 + 'espada12' + this.f,
    ...
    },
    {
      ...
      imagen3: this.imagen3 + 'espada3' + this.f,
      conjugacion:
        'Traidor, Esta conjunción deberá alertarte de una persona en tu entorno laboral, la cual probablemente este engañando o robando dentro de tu empresa o cerca de ti. Cuidado, ya que las malas intenciones de esta persona pudieran afectarte de manera indirecta. Será mejor tener cuidado con las acciones que realicen algunos compañeros de trabajo, así como con los documentos que firmas, evitando caer en situaciones comprometedoras.',
    },
    {
      imagen1: this.imagen1 + 'bastos10' + this.f,
      imagen2: this.imagen2 + 'bastos2' + this.f,
      conjugacion:
        'éxito en tus proyectos, Cuando sale esta combinación de cartas nos indica que el consultante está muy implicado y comprometido en algún proyecto. Puede parecer ambicioso su objetivo, pero aquí se aconseja mantener una buena comunicación con las partes implicadas, para alcanzar el logro decisivo.',
    },
    {
      imagen1: this.imagen1 + 'bastos10' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Buenas noticias, Tanto la Sota como el As de Bastos nos hablan de comienzos, movimientos y novedades, por lo tanto, esta combinación de cartas es una clara señal de que  todo marchará por el curso deseado. Recibiremos buenas y esperadas noticias, posiblemente del extranjero. Si el consultante se encuentra preparándose para rendir exámenes, los aprobará. En cuanto al amor, señala la presencia de un pretendiente dispuesto a luchar por quien consulta.',
    },
    {
      imagen1: this.imagen1 + 'bastos10' + this.f,
      imagen2: this.imagen2 + 'copa9' + this.f,
      conjugacion:
        'Comienzos felices, Esta combinación indica triunfo. Obtendremos el trabajo de nuestros sueños, así como las relaciones deseadas, tanto en amor como en amistades.',
    },
    {
      imagen1: this.imagen1 + 'bastos10' + this.f,
      imagen2: this.imagen2 + 'bastos4' + this.f,
      ...
      conjugacion:
        'Ruptura, Esta combinación nos habla de una relación de pareja que, si bien se muestra en el presente como formal y estable con el 4 de Copas, el 5 de Bastos indica que en los próximos meses sufrirá una ruptura, que puede ser o no temporal.',
    },
    {
      imagen1: this.imagen1 + 'bastos10' + this.f,
      imagen2: this.imagen2 + 'espada2' + this.f,
      conjugacion:
        'Celos, Aquí podemos observar la presencia de una tercera persona en discordia que daña la relación. También nos habla de celos y de una ruptura.',
    },
    {
      imagen1: this.imagen1 + 'bastos10' + this.f,
      imagen2: this.imagen2 + 'oro5' + this.f,
      conjugacion:
        'Pérdidas, Esta combinación indica oportunidades perdidas. También crisis y posibles rupturas en relaciones recientes.',
    },
    {
      imagen1: this.imagen1 + 'bastos11' + this.f,
      imagen2: this.imagen2 + 'asDeBastos' + this.f,
      conjugacion:
        'Ascenso laboral, A través de una llamada telefónica pueden llegar buenas noticias sobre un ascenso laboral que traerá felicidad para ti, solo que fíjate muy bien cuando pase la emoción sobre las condiciones del trabajo, ya que podría implicar un traslado a otra ciudad o país. Aunque al principio te parezca algo abrupto que implique muchos cambios en tu vida, debes tener la certeza que tú puedes lidiar con este reto y al final todo saldrá bien.',
    },
    {
      imagen1: this.imagen1 + 'bastos11' + this.f,
      imagen2: this.imagen2 + 'bastos6' + this.f,
      conjugacion:
        'Viajes por trabajo, Una muy buena oportunidad se presenta en tu trabajo o empresa, para viajar por trabajo, ya que te traerá buenas ganancias económicas, nuevos clientes y conocimientos para la actividad a la que te dedicas. Considera que podrías estar descuidando tu relación, si la tienes, y tal vez es momento de poner en la balanza a qué pondrás mayor atención y ser claro con tu pareja.',
    },
    {
      imagen1: this.imagen1 + 'bastos11' + this.f,
      imagen2: this.imagen2 + 'asDEOro' + this.f,
      conjugacion:
        'Ganancias económicas, Sin esperarlo llega una ganancia extra de dinero que te alegrará mucho, no es por un golpe de suerte, es más bien un bono o recompensa por tu buen trabajo, un reconocimiento a tu dedicación que no esperabas pero que te viene muy bien. O tal vez puede ser que si te dedicas al turismo o tu empresa tiene que ver con extranjeros, viene un pago extra por tu buen servicio en divisas extranjeras.',
    },
    {
      imagen1: this.imagen1 + 'bastos11' + this.f,
      imagen2: this.imagen2 + 'espada9' + this.f,
      conjugacion:
        'Trabajo que no se concreta, Esta tirada está alertando que el consultante recibirá una llamada telefónica o mensaje de texto, donde le notifican que el proyecto en el que habías puesto tanta fe, no se llevará a cabo o no autorizaron tu contratación; por lo que traerá a la vida del consultante desesperación y frustración.',
    },
    {
      imagen1: this.imagen1 + 'bastos11' + this.f,
      imagen2: this.imagen2 + 'espada11' + this.f,
